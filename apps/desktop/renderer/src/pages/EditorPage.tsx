...
function EditorPageInner({
    ...
    () => [
      {
        ...
        description: t("create.templates.desc"),
        icon: "layout",
        run: openTemplates,
      },
      {
        id: "ai",
        label: t("create.ai.label"),
      ...
      {
        id: "elements",
        label: t("create.elements.label"),
        description: t("create.elements.desc"),
        icon: "sparkles",
        run: openElements,
      },
    ],
    [t, openTemplates, openAiGenerate, openElements],
  );
  ...
  const commands = useMemo<PaletteCommand[]>(() => {
    ...
    const list: PaletteCommand[] = [
      ...
      {
        id: "openMagicResize",
        label: t("palette.cmd.magicResize"),
        group: t("palette.group.create"),
        icon: "move",
        keywords: ["resize", "reflow", "adapt", "sizes"],
        shortcut: shortcutBindings.openMagicResize,
        disabled: !hasArtboards,
        disabledReason: t("palette.disabled.createArtboard"),
        run: openMagicResize,
      },
      // Panels.
      {
        id: "openTheme",
        label: t("palette.cmd.openTheme"),
      ...
      {
        id: "openExport",
        label: t("palette.cmd.openExport"),
        group: t("palette.group.panels"),
        icon: "download",
      ...
      // Tools.
      ...toolOrder.map<PaletteCommand>((toolId) => ({
        id: `tool:${toolId}`,
        label: t("palette.tool.label", { name: t(`topbar.tool.${toolId}`) }),
        group: t("palette.group.tools"),
        icon: TOOL_LABELS[toolId].icon,
        keywords: ["tool", toolId],
        shortcut: toolBindingFor[toolId],
        run: () => selectToolFromPalette(toolId),
      })),
      // Studios (editor modes).
      ...EDITOR_MODES.map<PaletteCommand>(({ mode: m }) => ({
        id: `mode:${m}`,
        label: t("palette.studio.label", { name: t(`topbar.mode.${m}`) }),
        group: t("palette.group.studios"),
        icon: "layout",
      ...
      {
        id: "undo",
        label: t("palette.cmd.undo"),
        group: t("palette.group.edit"),
        icon: "undo",
        keywords: ["undo", "revert"],
        shortcut: shortcutBindings.undo,
        disabled: !canUndo,
        disabledReason: t("palette.disabled.nothingToUndo"),
        run: () => void handleUndo(),
      },
      {
        id: "redo",
        label: t("palette.cmd.redo"),
        group: t("palette.group.edit"),
        icon: "redo",
        keywords: ["redo"],
        shortcut: shortcutBindings.redo,
        disabled: !canRedo,
        disabledReason: t("palette.disabled.nothingToRedo"),
        run: () => void handleRedo(),
      },
      {
        id: "selectAll",
        label: t("palette.cmd.selectAll"),
        group: t("palette.group.edit"),
        keywords: ["select", "all"],
      ...
      {
        id: "copy",
        label: t("palette.cmd.copy"),
        group: t("palette.group.edit"),
        keywords: ["copy", "clipboard"],
        shortcut: shortcutBindings.copy,
        disabled: !hasSelection,
        disabledReason: t("palette.disabled.nothingSelected"),
        run: () => void handleCopy(),
      },
      {
        id: "paste",
        label: t("palette.cmd.paste"),
        group: t("palette.group.edit"),
      ...
      {
        id: "deleteSelection",
        label: t("palette.cmd.deleteSelection"),
        group: t("palette.group.edit"),
